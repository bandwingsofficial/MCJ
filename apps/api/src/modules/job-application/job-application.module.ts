...
import { AuthenticatedJobApplicationController } from './presentation/controllers/authenticated-job-application.controller';
...
@Module({
  ...
  controllers: [
    ...
    AuthenticatedJobApplicationController,
    PublicJobApplicationController,
    AdminJobApplicationController,
  ...
  providers: [
    ...
    {
      provide: CreateJobApplicationWithStudentHandler,
      useFactory: (
        applicationRepo: JobApplicationRepository,
        jobRepo: JobRepository,
        studentRepo: StudentRepository,
        ...
        new CreateJobApplicationWithStudentHandler(
          applicationRepo,
          jobRepo,
          studentRepo,
          branchRepo,
    ...
    },
    {
      ...
      useFactory: (
        ...
        new ListJobApplicationsHandler(applicationRepo, studentRepo),
      inject: [
        JOB_APPLICATION_TOKENS.JOB_APPLICATION_REPOSITORY,
        STUDENT_TOKENS.STUDENT_REPOSITORY,
      ],
