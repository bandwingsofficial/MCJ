...
import { useBranchManagerDashboard } from "@/src/features/dashboard/hooks/use-branch-manager-dashboard";
...
const QUICK_ACTIONS = [
  { label: "View students", href: "/students", icon: UserPlus },
  { label: "View enrollments", href: "/enrollments", icon: Layers },
  { label: "View batches", href: "/batches", icon: Boxes },
  { label: "Take attendance", href: "/attendance", icon: BookOpen },
...
function resolveActivityViewAllHref(
  items: BranchManagerDashboardData["recentActivity"],
): string {
...
function resolveScheduleViewAllHref(
  items: BranchManagerDashboardData["upcomingSchedule"],
): string {
...
function DashboardQuickActionsAside() {
  return (
...
export function BranchManagerDashboardPage() {
  ...
  const { data, loading, error, reload } = useBranchManagerDashboard(query);
  ...
  const displayName = user
    ...
    : "Branch Manager";
  const branchLabel = resolvePortalBranchName(user?.branch ?? null, data?.branch);
      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-[#647A9B]">
            Branch overview for {branchLabel} — students, batches, and
            recruiting at your location only.
          </p>
          {data?.period ? (
        ...
        <>
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 xl:grid-cols-4 xl:grid-rows-1">
            <DashboardMetricCard
              ...
              metric={data.metrics.activeStudents}
              icon={UserPlus}
              href="/students"
          ...
          <div className="grid grid-cols-1 gap-6 xl:grid-cols-[minmax(0,1fr)_min(100%,280px)] xl:items-start">
          ...
          <div className="grid gap-4 lg:grid-cols-2">
            ...
            <SectionShell
              ...
              subtitle={`Trainers assigned to ${branchLabel}`}
          ...
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <DashboardMetricCard
              ...
              metric={data.metrics.trainersWithBranchAssignments}
              icon={Users}
              href="/users"
