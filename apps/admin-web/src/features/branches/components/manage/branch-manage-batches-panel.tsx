...
import { BranchBatchLifecycleTabs } from "@/src/features/branches/components/manage/branch-batch-lifecycle-tabs";
...
const EMPTY_TAB_MESSAGES: Record<BatchLifecycleStatus, string> = {
  UPCOMING: "No upcoming batches assigned to this branch.",
...
export function BranchManageBatchesPanel({
  ...
  const [lifecycleTab, setLifecycleTab] =
    useState<BatchLifecycleStatus>("UPCOMING");
  ...
  const lifecycleCounts = useMemo(
    () => countBranchBatchesByLifecycle(allBatches),
    [allBatches],
  );
      ...
      <div className="space-y-3">
        ...
        <div className={BRANCH_TABLE_CARD_CLASS}>
          <BranchManageTableShell
            ...
            emptyDescription={
              allBatches.length === 0
                ? "Assign batches to this branch to get started."
