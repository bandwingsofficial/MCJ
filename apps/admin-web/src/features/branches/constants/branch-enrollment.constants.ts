export const BRANCH_ENROLLMENT_PAYMENT_METHODS = [
...
export type BranchEnrollmentPaymentMethod =
  (typeof BRANCH_ENROLLMENT_PAYMENT_METHODS)[number]["value"];

export const BRANCH_INSTALLMENT_STATUS_OPTIONS = [
...
export function todayEnrollmentDateValue(): string {
