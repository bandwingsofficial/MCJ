...
import type { FinanceNewsFilterStatus } from "@/src/features/finance-news/types/finance-news.types";
...
interface Props {
  ...
  onStatusChange: (status: FinanceNewsFilterStatus | undefined) => void;
  categoryId?: string;
...
export function FinanceNewsSummaryHeader({
  total,
  isLoading = false,
                ...
                <AppSelect
                  ...
                  onValueChange={(value) =>
                    onStatusChange(
                      value === "ALL"
                        ? undefined
                        : (value as FinanceNewsFilterStatus),
                    )
                  }
                  options={[
