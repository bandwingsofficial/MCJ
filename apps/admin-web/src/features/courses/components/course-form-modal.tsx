...
import { Modal } from "@/src/shared/components/ui/model"; // Make sure to adjust this import path to match your project structure
        ...
        defaultValues={
          course
            ? {
                ...
                branchId: course.branchId ?? undefined,
