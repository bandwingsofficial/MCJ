...
import { filterSelfPacedVideoLessons } from "@/src/features/course-modules/hooks/use-module-content-data";
  ...
  return (
    ...
    <Card className="rounded-xl border border-slate-200 p-4 shadow-sm">
      ...
      <ModuleContentTable<VideoRow>
        ...
        emptyTitle="No self-paced videos yet"

        emptyDescription="Create a video learners can watch on demand."
