          ...
          >
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              ...
              <button
                ...
                className="inline-flex shrink-0 items-center justify-center rounded-lg bg-gradient-to-r from-[#2F6BE5] to-[#1E49A8] px-5 py-2.5 text-xs font-semibold text-white transition hover:from-[#2860D4] hover:to-[#1A3F96] focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
              >
