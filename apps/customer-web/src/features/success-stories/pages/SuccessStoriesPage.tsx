...
const testimonials = [
  {
    ...
    text: "MCJ Academy gave me practical knowledge in Tally and GST. I got placed within 2 months.",
  },
  {
    name: "Sneha Patil",
    role: "GST Analyst",
  ...
  },
  {
    ...
    text: "Best training academy. The placement team is very supportive.",
  },
];
        ...
        <Container>
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="mt-6 text-gray-600 leading-relaxed">
              ...
              taxation, and finance with real-world training and placement
              support.
            </p>
          </div>
        </Container>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-gray-600 leading-relaxed">
                With structured learning, practical exposure, and placement
                support, success becomes achievable.
              </p>
        ...
        <Container>
          <div className="text-center text-white max-w-2xl mx-auto">
            ...
            <p className="text-gray-300 mb-6">
              Start your journey with MCJ Academy today.
            </p>
