        ...
        ">
          ...
          <div className="max-w-xs">
            <div className="flex items-center gap-3 mb-4">
              <Image
                ...
                style={{ height: "auto" }}
              />
              <h2 className="text-lg font-semibold">MCJ Institute</h2>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <FaWhatsapp className="w-5 h-5 cursor-pointer hover:text-green-600" />
            </div>
          </div>
          ...
          <div className="max-w-sm">
            ...
            <div className="flex gap-3 mt-5">
              <button className="border px-3 py-2 rounded-md text-xs hover:bg-gray-100">
                Google Play
              </button>
              <button className="border px-3 py-2 rounded-md text-xs hover:bg-gray-100">
                App Store
